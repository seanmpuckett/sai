...
var __context={"name":"sai.sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-03-07T23:17:34.303Z","fetched":"2018-03-07T23:19:31.978Z"};
var _FS = require('fs');
...
var _CONSTRUCTS = ['StateC', 'PromisingC', 'ReturnC', 'IterateC', 'TryCatchC', 'IfElseC', 'SwitchC'];
    ...
    for ($10 = 0; $10 < $12; $10++) {
      ...
      try {
        ...
        for (_constructName in $7) {
          ...
          if (!($AI.count_op((_construct.clauses)))) {
...
prototype['Dedenter'] = function(p) {
  var $_d, $_c, $35, $34, $33, $32, $31, $30, $29, $28, $27, $26, $25, $24, $23, _heredoc, _isBlank, _isComment, _trimmed, $22, _depth, $21, _trail, _line, $20, $19, $18, $17, $16, $15, _result, _lineno, _Context, _lines, _indent, _heredepth, _heredocstate, _rawlines, $14, _src = p,
    ...
    _Context = function(p) {
      var _lineno = p; {
        ...
        var $16 = (_lineno - 3),
          $17 = (_lineno + 4),
          $18 = 1;
        if ($18 <= 0) throw new Error("SAI Runtime: Infinite looping COUNT detected.");
        for (; $16 < $17; $16 = $16 + $18) {
          if (undefined !== ($15 = (_rawlines[$16]))) {
            _result += '' + $16 + ':' + ((($16 === _lineno)) ? ('->') : ('  ')) + ' ' + $15 + '\n';
          };
        }
        return (_result);
      }
...
prototype['GetProtogen'] = function(p) {
  var $_d, $_c, $72, _s2, _protogen, _source, _load, _s1, $71, _name = p,
    ...
    if (undefined === $.protogens[_name]) $.protogens[_name] = function(p) {
      {
        ...
        _s2 = new Date();
        if ($72 = ($.config.options.speedometer)) {
...
prototype['GetAncestors'] = function(p) {
  var $_d, $_c, $79, $78, $77, $76, $75, _opts, _protogen, _obj, _leaf, _nodupes, _ancestors, _heritage, $74, _name = p,
...
prototype['GetPrototype'] = function(p, _bindings) {
  var $_d, $_c, $87, _protogen, $86, $85, $84, $83, $82, _adopt, _prototype, _ancestors, $81, _name = p,
...
prototype['GetSource'] = function(p) {
  var $_d, $_c, $94, $93, $92, $91, $90, _adopt, _source, $89, _islib, _ancestors, $88, _name = p,
...
prototype['Configure'] = function(p) {
  var $108, $107, $106, $105, $104, $103, $102, _c = p,
    $ = this['Configure'] ? this : $bindfail('Configure'); {
    if (undefined !== ($103 = (_c.paths))) {
      $.config.paths = $103;
    }
    if (undefined !== ($104 = (_c.verbs))) {
      $.config.verbs = $AI.update_op($.config.verbs, $104);
    }
    if (undefined !== ($105 = (_c.options))) {
      $.config.options = $AI.update_op($.config.options, $105);
    }
    if (undefined !== ($106 = (_c.constructs))) {
      $.config.constructs = $AI.update_op($.config.constructs, $106);
    }
    if (undefined !== ($107 = (_c.Loader))) {
      $.config.Loader = $107;
    }
    if ($108 = ($.config.options.beautify)) {
