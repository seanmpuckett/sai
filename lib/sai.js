...
var __context={"name":"sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-02-18T21:29:58.958Z","fetched":"2018-02-18T21:30:02.297Z"};
var _FS = require('fs');
...
var $2g = prototype['Clean'] || function() {};
...
var $3g = prototype['Dedenter'] || function() {};
...
var $4g = prototype['WrapExtract'] || function() {};
...
var $5g = prototype['Contextualize'] || function() {};
...
var $6g = prototype['GetParser'] || function() {};
...
var $7g = prototype['GetSourceFromPaths'] || function() {};
...
var $8g = prototype['Compile'] || function() {};
...
var $9g = prototype['GetProtogen'] || function() {};
...
var $10g = prototype['Expression'] || function() {};
...
var $11g = prototype['GetAncestors'] || function() {};
...
var $12g = prototype['GetPrototype'] || function() {};
prototype['GetPrototype'] = function(p, _bindings) {
  var $_d, $_c, $87, _protogen, $86, $85, $84, $83, _adopt, _proto, _ancestors, $79, _name = p,
    $ = this; {
...
var $13g = prototype['GetSource'] || function() {};
...
var $14g = prototype['Require'] || function() {};
...
var $15g = prototype['Create'] || function() {};
...
var $16g = prototype['Configure'] || function() {};
prototype['Configure'] = function(p) {
  var $109, $108, $107, $106, $105, $104, _config = p,
    $ = this; {
    if (undefined !== ($105 = (_config.paths))) {
      $.config.paths = $105;
    }
    if (undefined !== ($106 = (_config.verbs))) {
      $.config.verbs = $AI.update_op($.config.verbs, $106);
    }
    if (undefined !== ($107 = (_config.options))) {
      $.config.options = $AI.update_op($.config.options, $107);
    }
    if (undefined !== ($108 = (_config.Loader))) {
      $.config.Loader = $108;
    }
