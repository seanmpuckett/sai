...
var __context={"name":"sai.sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-03-10T18:29:22.155Z","fetched":"2018-03-10T21:16:24.982Z"};
var _FS = require('fs');
...
var _CONSTRUCTS = ['StateC', 'PromisingC', 'ReturnC', 'IterateC', 'TryCatchC', 'IfElseC', 'SwitchC', 'ListsP', 'QueryP', 'CrudP'];
    ...
    for ($12 = 0; $12 < $14; $12++) {
      ...
      try {
        ...
        for (_category in $9) {
          ...
          $.config[_category] = $AI.overlay_op($.config[_category], _library);;
        }
      } catch ($11) {
        $AI.debug_op($11);
      };
...
prototype['Configure'] = function(p) {
  var $114, $113, $112, $111, $110, $109, $108, _c = p,
    ...
    if (undefined !== ($110 = (_c.verbs))) {
      $.config.verbs = $AI.overlay_op($.config.verbs, $110);
    }
    if (undefined !== ($111 = (_c.options))) {
      $.config.options = $AI.overlay_op($.config.options, $111);
    }
    if (undefined !== ($112 = (_c.constructs))) {
      $.config.constructs = $AI.overlay_op($.config.constructs, $112);
    }
