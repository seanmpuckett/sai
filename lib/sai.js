...
var __context={"name":"sai.sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-03-09T17:06:04.499Z","fetched":"2018-03-09T18:27:58.584Z"};
var _FS = require('fs');
...
var _CONSTRUCTS = ['StateC', 'PromisingC', 'ReturnC', 'IterateC', 'TryCatchC', 'IfElseC', 'SwitchC', 'PipersC'];
...
prototype['Clean'] = function(p) {
  var $_d, $_c, $15, $14, $13, $12, $11, $10, $9, $8, $7, $6, $5, $4, $3, _type, _x, _clauseName, _requestedSyntax, $2, $1, _element, _description, _constructName, _construct, _category, _library, _manifest, _implementation, _fn, _file, _msg, _fail, _requiredElements, _validSyntax, $0, $ = this['Clean'] ? this : $bindfail('Clean'); {
    $.prototypes = {};
    $.sources = {};
    $.protogens = {};
    $.isas = {};
