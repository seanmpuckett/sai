...
var __context={"name":"sai.sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-03-16T13:09:52.061Z","fetched":"2018-03-17T13:34:35.139Z"};
var _FS = require('fs');
      ...
      var _rawsource = p; {
        ...
        try {
          ...
          if (undefined !== ($81 = (_location))) {
            $82.message = 'SAI: Syntax error <HERE> in\n' + _meta + '\n' + '' + '\n' + '' + $.Contextualize(_source, _location) + '\n' + '' + '\n' + '' + $82.message + '\n' + '';
          } else {
            $82.message = 'SAI: Error creating prototype in\n' + _meta + '\n' + '' + '\n' + '' + $82.message + '\n' + '';
          }
          throw $82;
        }
