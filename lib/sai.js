...
var __context={"name":"sai","loader":"SAI.GetSourceFromPaths","path":"src/sai.sai","mtime":"2018-02-16T16:29:04.147Z","fetched":"2018-02-17T22:41:00.802Z"};
var _FS = require('fs');
...
prototype['GetParser'] = function(p) {
  var $_d, $_c, $49, $48, $47, _js, _source, _fn, _bound, _rawsource, $46, $45, _msg, $44, _mainParser, _grammar, _PEG, _parserFile, _grammarFile, $43, $ = this; {
    try {
...
prototype['GetAncestors'] = function(p) {
  var $_d, $_c, $75, $74, $73, $72, _opts, _protogen, _obj, _leaf, _nodupes, _ancestors, _heritage, $68, _name = p,
    $ = this; {
    _heritage = [_name];
    _ancestors = {};
    _nodupes = {};
