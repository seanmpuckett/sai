...
var __context={"loader":"SAI.GetSourceFromFilename","path":"src/sai.sai","workdir":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src","mtime":"2018-04-06T16:25:38.086Z","fetched":"2018-04-07T15:20:52.329Z"};
...
prototype['Dedenter'] = function(p) {
  var $32_this, $33_this, $34_counter, $35_stop, $36_step, $37_none, $38_trial, $39_trial, $40_stop, $41_step, $42_none, $43_trial, $44_this, $45_this, $46_trial, $47_trial, $48_trial, $49_trial, $50_trial, $51_trial, $52_trial, $53_trial, $54_trial, $55_trial, $56_trial, $57_trial, $58_this, $59_trial, $60_trial, $61_trial, $62_list, $63_length, $64_none, $65_this, $ = this['Dedenter'] ? this : $bindfail('Dedenter'),
    ...
    _Context = function(p) {
      var _lineno = p; {
        ...
        var $34_counter = (_lineno - 3),
          $35_stop = (_lineno + 4),
          $36_step = 1;
        if (!($36_step > 0)) $count$stepup($36_step);
    ...
    var _i = 0,
      ...
      $41_step = 1;
    if (!($41_step > 0)) $count$stepup($41_step);
...
prototype['Require'] = function(p) {
  var $132_this, $133_trial, $ = this['Require'] ? this : $bindfail('Require'),
    _ctor, _name = p,
    _proto; {
    if (undefined !== (_proto = ($.GetPrototype(_name)))) {
      ...
      if ($133_trial = (('function' === typeof(_proto)))) {
        return (_proto);
      }
    }
...
prototype['Create'] = function(p, _parameters) {
  var $134_this, $135_trial, $136_trial, $137_this, $ = this['Create'] ? this : $bindfail('Create'),
    $_c, $_d, _name = p,
    _obj; {
    if (undefined !== ($137_this = ($.GetPrototype(_name)))) {
      _obj = Object.create($137_this);
      if ($135_trial = (_obj.Constructor)) {
        _obj.Constructor();;
      }
      if ($136_trial = (_obj.Instantiate)) {
...
prototype['Configure'] = function(p) {
  var $138_this, $139_this, $140, $141_this, $142, $143_this, $144, $145_this, $146_this, $147_trial, $ = this['Configure'] ? this : $bindfail('Configure'),
    _c = p; {
    if (undefined !== ($139_this = (_c.paths))) {
      $.config.paths = $139_this;
    }
    if (undefined !== ($141_this = (_c.verbs))) {
      $140 = $.config.verbs;
      $.config.verbs = $AI.overlay_op($140, $141_this);
    }
    if (undefined !== ($143_this = (_c.options))) {
      $142 = $.config.options;
      $.config.options = $AI.overlay_op($142, $143_this);
    }
    if (undefined !== ($145_this = (_c.constructs))) {
      $144 = $.config.constructs;
      $.config.constructs = $AI.overlay_op($144, $145_this);
    }
    if (undefined !== ($146_this = (_c.Loader))) {
      $.config.Loader = $146_this;
    }
    if ($147_trial = ($.config.options.beautify)) {
...
prototype['RegisterWithNode'] = function(p) {
  var $148_this, $149_this, $ = this['RegisterWithNode'] ? this : $bindfail('RegisterWithNode'),
    $_c, $_d, _REQUIRE, _filename, _module, _result; {
    _REQUIRE = require;
    if (undefined !== ($149_this = (_REQUIRE.extensions))) {
      $149_this.sai = function(p, _filename) {
        var _module = p; {
...
prototype['Environment'] = function(p) {
  var $150_this, $ = this['Environment'] ? this : $bindfail('Environment'); {
    return ({
      dynamic: true,
      static: false,
      paths: $.config.paths,
