...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-15T00:31:40.508Z"};
...
var __context={"name":"Keywords.sai","loader":"SAI.GetSourceFromPaths","path":"src/Keywords.sai","mtime":"2018-03-14T19:54:20.996Z","fetched":"2018-03-15T00:31:39.636Z"};
...
var t = {
  boringlist: ['{', '}', ']', '%%DEDENT%%', '%%INDENT%%', ',', ')', '0x', '0o', '::', '\\\\\'', '{;', '};', '\\\\/', '\\\\;', '\\', '\\\\', '__column', '__line', '__offset', '__source', '^'],
  ...
  var $19, $ = this['Documentation'] ? this : $bindfail('Documentation'); {
    return ({
      ...
      'operators': {
        ...
        '+': {
          title: '+',
          subtitle: 'addition / string concatenation operator',
          summary: 'summary',
          synref: '.. [expr] + [expr]' + '\n' + '',
        ...
        '-': {
          title: '- (minus)',
          subtitle: 'subtraction/negation operator',
          summary: 'summary',
          synref: '.. [lexpr] - [rexpr]' + '\n' + '.. - [expr]',
        ...
        '/': {
          title: '/ (forward slash)',
          subtitle: 'mathematical division operator',
        ...
        '>>': {
          subtitle: 'signed bitwise right shift operator',
        ...
        '>>>': {
          subtitle: 'unsigned bitwise right shift operator',
        ...
        'copy': {
          subtitle: 'shallow copy operator',
        ...
        'create': {
          subtitle: 'object creation operator',
        ...
        'default': {
          subtitle: 'variable initialization operator',
        ...
        'inc': {
          subtitle: 'value increment operator',
        ...
        'is': {
          subtitle: 'equivalence test operator',
        ...
        'isof': {
          subtitle: 'object information trait/operator',
        ...
        'nand': {
          subtitle: 'not-and logical operator',
        ...
        'new': {
          subtitle: 'object instantiation operator',
        ...
        'nor': {
          subtitle: 'not-or logical operator',
        ...
        'number': {
          subtitle: 'numeric coercion operator',
        ...
        'singleton': {
          subtitle: 'singleton object access operator',
        ...
        'typeof': {
          subtitle: 'javascript type disclosure operator',
        ...
        'xor': {
          subtitle: 'logical exclusive-or operator',
        ...
        'xorb': {
          subtitle: 'binary exclusive-or operator',
      ...
      'syntax': {
        ...
        '\'d': {
          ...
          summary: 'An alternate way of invoking a verb on an object.',
        ...
        '\'s': {
          title: '\'s (attribute)',
          subtitle: 'conversational syntax',
          summary: 'An alternate way of referencing the attributes of an object.',
        ...
        '..': {
          ...
          summary: 'You can use the two-dot caboose to stitch a *single line* child code block onto the end of the' + '\n' + 'statement that requires it.',
        ...
        '...': {
          ...
          summary: 'You can use the three-dot continue syntax to insert line breaks, or multiple child code blocks,' + '\n' + 'into a single statement.',
        ...
        '<-': {
          ...
          summary: 'Ensures the expression on the right is calculated before the expression on the left.',
