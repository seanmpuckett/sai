...
var __context={"loader":"SAI.GetSourceFromFilename","path":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src/Construct.sai","workdir":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src","mtime":"2018-04-04T23:09:42.435Z","fetched":"2018-04-11T21:09:44.060Z"};
...
var __context={"loader":"SAI.GetSourceFromFilename","path":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src/Keywords.sai","workdir":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src","mtime":"2018-04-11T16:56:16.451Z","fetched":"2018-04-11T21:09:43.077Z"};
var __path=require('path');
var __require=function(fn) {
  try {
    return require(fn);
  ...
  var $19_this, $ = this['Documentation'] ? this : $bindfail('Documentation'); {
    return ({
      ...
      'operators': {
        ...
        'or': {
          subtitle: 'logical or',
          summary: 'Checks two or more values; returns the first one examined that is _truthy_. Otherwise' + '\n' + 'returns the last value checked.',
          synref: '.. [expr] or [expr]' + '\n' + '.. and [list of expressions]',
      ...
      'syntax': {
        ...
        '(': {
          ...
          summary: 'Parenthesis wrap expressions that should be evaluated together, and also invokes functions.',
        ...
        'call': {
          ...
          summary: '**Call** invokes the identifier as a function call that returns a value, passing in any parameters that follow.' + '\n' + '',
          synref: '.. call [identifier] ([parameters]) (;)',
          detail: 'This is a synonym for __from__ and will likely be what replaces it.' + '\n' + '' + '\n' + ''
        },
        'from': {
          subtitle: 'function invocation',
      ...
      'keywords': {
        ...
        'unbound': {
          ...
          summary: 'An __unbound__ function is not \'attached\' in any way (other than by name) to any instance of its' + '\n' + 'object.',
