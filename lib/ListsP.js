...
var __context={"loader":"SAI.GetSourceFromFilename","path":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src/Construct.sai","workdir":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src","mtime":"2018-04-04T23:09:42.435Z","fetched":"2018-04-11T22:24:03.881Z"};
...
var __context={"loader":"SAI.GetSourceFromFilename","path":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src/ListsP.sai","workdir":"/Users/seanmpuckett/Documents/ProjSync/Node/sai/src","mtime":"2018-04-11T16:56:50.611Z","fetched":"2018-04-11T22:24:03.567Z"};
var __path=require('path');
var __require=function(fn) {
  try {
    return require(fn);
...
prototype.__tobelocked = prototype.__tobelocked.concat(["manifest", "docs", "IntoPiper", "TotalPiper", "ReducePiper", "AuditPiper", "ThruPiper", "ArraysPiper", "KVPiper", "ReplicatePiper", "Documents", "isa"]);
prototype.__tobefrozen = prototype.__tobefrozen.concat(["isof"]);
      ...
      return ({
        'pipers': {
          ...
          'reduce': {
            ...
            handler: function() {
              return ($.ReducePiper).apply($, arguments);
            }
          },
          'keys': {
            clauses: {
  ...
  $AI.expectsThrow(p, {
    ...
    switch ($2 = (p.work.type)) {
      case 'into.valexpr':
        ...
        _pattern = '$AI.sum_op(' + $.SPLIT + ',' + _fn + ',' + _startvalue + ')';
        break;
      case 'into.valoutblock':
        ...
        break;
      case 'into.valuse':
        _pattern = '$AI.sum_op(' + $.SPLIT + ',' + p.work.args.use + ',' + _startvalue + ')';
        break;
      default:
        return ({
  ...
  $AI.expectsThrow(p, {
    ...
    switch ($4 = (p.work.type)) {
      case 'total.expr':
        ...
        _fn = p.tools.replacer(_fn, _vars);
        _pattern = '$AI.sum_op(' + $.SPLIT + ',' + _fn + ',undefined)';
        break;
      case 'total.use':
        _pattern = '$AI.sum_op(' + $.SPLIT + ',function(s,v,k){ var t=(' + p.work.args.use + ').call($,v,k); return (s===undefined)?t:s+t; },undefined)';
        break;
      case 'total.none':
        _pattern = '$AI.sum_op(' + $.SPLIT + ',function(s,i){' + '\n' + '  return (undefined===s) ? i : s+i;' + '\n' + '},undefined)' + '\n' + '';
        break;
      default:
        return ({
...
var $5g = prototype['ReducePiper'] || function() {};
prototype['ReducePiper'] = function(p) {
  var $5_this, $6, $ = this['ReducePiper'] ? this : $bindfail('ReducePiper'),
    $_c, $_d, _fn, _outs, _pattern, _tools, _vars;
  $AI.expectsThrow(p, {
    "work": true,
    "tools": true
  }, '\'ReducePiper\''); {
    ...
    switch ($6 = (p.work.type)) {
      ...
      case 'reduce.outblock':
        ...
        break;
      case 'reduce.use':
        _pattern = '$AI.reduce_op(' + $.SPLIT + ',' + p.work.args.use + ')';
        break;
      default:
        return ({
          error: 'Unhandled piper type ' + $6 + ' in IntoPiper'
        });
        break;
    }
    return ({
...
var $6g = prototype['AuditPiper'] || function() {};
prototype['AuditPiper'] = function(p) {
  var $7_this, $8, $ = this['AuditPiper'] ? this : $bindfail('AuditPiper'),
...
var $7g = prototype['ThruPiper'] || function() {};
prototype['ThruPiper'] = function(p) {
  var $10, $9_this, $ = this['ThruPiper'] ? this : $bindfail('ThruPiper'),
    $_c, $_d, _fn, _op, _outs, _pattern, _tools, _vars;
  $AI.expectsThrow(p, {
    "work": true,
    "tools": true
    ...
    switch ($10 = (p.work.type)) {
      ...
      default:
        return ({
          error: 'Unhandled piper type ' + $10 + ' in ThruPiper'
        });
        break;
    }
    return ({
...
var $8g = prototype['ArraysPiper'] || function() {};
prototype['ArraysPiper'] = function(p) {
  var $11_this, $12, $ = this['ArraysPiper'] ? this : $bindfail('ArraysPiper'),
    $_c, $_d, _fn, _pattern, _tools, _vars;
  $AI.expectsThrow(p, {
    "work": true,
    "tools": true
    ...
    switch ($12 = (p.work.type)) {
      ...
      case 'entrait.none':
        ...
        break;
      case 'enkey.none':
        _pattern = '$AI.sum_op(' + $.SPLIT + ',function(s,a){s[a]=true;return s;},{})';
        break;
      case 'enkey.expr':
        _vars = {
          'this': 'v',
        ...
        _fn = '\x5e{block}';
        _fn = p.tools.replacer(_fn, _vars);
        _pattern = '$AI.sum_op(' + $.SPLIT + ',function(s,v,k){s[v]=' + _fn + ';return s;},{})';
        break;
      default:
        return ({
...
var $9g = prototype['KVPiper'] || function() {};
prototype['KVPiper'] = function(p) {
  var $13_this, $14, $ = this['KVPiper'] ? this : $bindfail('KVPiper'),
    _pattern, _tools;
  $AI.expectsThrow(p, {
    "work": true,
    "tools": true
    ...
    switch ($14 = (p.work.type)) {
      ...
      default:
        return ({
          error: 'Unhandled piper type ' + $14 + ' in KVPiper'
        });
        break;
    }
    return ({
...
var $10g = prototype['ReplicatePiper'] || function() {};
prototype['ReplicatePiper'] = function(p) {
  var $15_this, $16, $ = this['ReplicatePiper'] ? this : $bindfail('ReplicatePiper'),
  ...
  $AI.expectsThrow(p, {
    ...
    switch ($16 = (p.work.type)) {
      ...
      default:
        return ({
          error: 'Unhandled piper type ' + $16 + ' in ReplicatePiper'
        });
        break;
    }
    return ({
