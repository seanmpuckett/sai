...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-18T20:07:20.981Z"};
...
var __context={"name":"ListsP.sai","loader":"SAI.GetSourceFromPaths","path":"src/ListsP.sai","mtime":"2018-03-18T19:27:03.489Z","fetched":"2018-03-18T20:07:20.646Z"};
...
prototype['ReplicatePiper'] = function(p) {
  var $_d, $_c, $14, _tools, _pattern, $13, $ = this['ReplicatePiper'] ? this : $bindfail('ReplicatePiper');
  $AI.expectsThrow(p, {
    "work": true,
    "tools": true
  }, '\'ReplicatePiper\''); {
...
prototype['Documents'] = function(p) {
  var $15, $ = this['Documents'] ? this : $bindfail('Documents'); {
    return ({
      pipers: {
        'set': {
