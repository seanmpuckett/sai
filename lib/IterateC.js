...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-07T14:21:44.851Z","fetched":"2018-03-07T23:19:31.742Z"};
...
var __context={"name":"IterateC.sai","loader":"SAI.GetSourceFromPaths","path":"src/IterateC.sai","mtime":"2018-03-07T23:19:26.026Z","fetched":"2018-03-07T23:19:31.488Z"};
    ...
    try {
      ...
      switch ($25 = (_main.type)) {
        case 'count.exprsoutblock':
          ...
          _preface = 'var \x5e{counter}=\x5e{start},\x5e{stop}=\x5e{kstop},\x5e{step}=\x5e{kstep};' + '\n' + 'if (\x5e{step}<=0) throw new Error("SAI Runtime: Infinite looping COUNT detected.");' + '\n' + '';
          _elseclause = function(p) {
            {
              if (!(_none)) {
                return ('');
