...
var __context={"loader":"SAI.GetSourceFromFilename","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-27T22:47:35.309Z"};
...
var __context={"loader":"SAI.GetSourceFromFilename","path":"src/QueryP.sai","mtime":"2018-03-26T15:07:16.181Z","fetched":"2018-03-27T22:47:35.114Z"};
...
prototype['SortPiper'] = function(p) {
  ...
  $AI.expectsThrow(p, {
    ...
    _tools = [];
    _Repl = p.tools.replacer;
    _grammar = $AI.reduce_op_fast(p.clauses, function($11_sum, $9_this, $10_key) {
      var $t = $9_this.clause;
    ...
    switch ($24 = (_work.type)) {
      case 'by.expr':
        try {
          _keyed = false;
          _pattern = $AI.alter_op($AI.reduce_op_fast($AI.map_op($AI.reduce_op_fast(p.clauses, function($15_intosum, $13_intothis, $14_intokey) {
