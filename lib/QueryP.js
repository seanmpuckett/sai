...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-15T00:31:41.251Z"};
...
var __context={"name":"QueryP.sai","loader":"SAI.GetSourceFromPaths","path":"src/QueryP.sai","mtime":"2018-03-15T00:26:25.690Z","fetched":"2018-03-15T00:31:41.078Z"};
...
prototype['SortPiper'] = function(p) {
  var $_d, $_c, $_b, $23, $22, $21, _fn, _vars, _outs, $20, _msg, $19, $18, $17, $16, $15, $14, $13, $12, _work, $11, $10, $9, _grammar, _Repl, _tools, _pattern, $8, $ = this['SortPiper'] ? this : $bindfail('SortPiper');
  $AI.expectsThrow(p, {
    "clauses": true,
    "tools": true
  }, '\'SortPiper\''); {
    ...
    switch ($23 = (_work.type)) {
        ...
        try {
          _pattern = $AI.alter_op($AI.reduce_op_fast($AI.map_op($AI.reduce_op_fast(p.clauses, function($15, $13, $14) {
            switch ($12 = ($13.clause)) {
              case 'by':
                $15.push({
                  expr: ((undefined !== ($_b = $13.args.expr)) ? $_b : '$13'),
                  order: 1
                });
                break;
              case 'asc':
      ...
      default:
        return ({
          error: 'Unhandled piper type ' + $23 + ' in SortPiper'
        });
        break;
    }
    return ({
...
prototype['LimitPiper'] = function(p) {
  var $27, $26, _ct, _st, $25, _work, _tools, _pattern, $24, $ = this['LimitPiper'] ? this : $bindfail('LimitPiper');
  $AI.expectsThrow(p, {
    "clauses": true,
    "tools": true
  }, '\'LimitPiper\''); {
    ...
    _tools = [];
    _work = p.clauses[0];
    if ($25 = ((p.clauses.length > 1))) {
      return ({
        error: 'SAI Compiler: ' + _work.clause + ' should not have multiple clauses.'
      });
    }
    switch ($27 = (_work.type)) {
      case 'limit.exprs':
        if ($26 = ((_work.args.exprs.length === 1))) {
          _st = undefined;
      ...
      default:
        return ({
          error: 'Unhandled piper type ' + $27 + ' in LimitPiper'
        });
        break;
    }
    return ({
...
prototype['Documents'] = function(p) {
  var $28, $ = this['Documents'] ? this : $bindfail('Documents'); {
    return ({
      'pipers': {
        'limit': {
