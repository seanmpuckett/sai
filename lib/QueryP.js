...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-12T01:03:09.886Z"};
...
var __context={"name":"QueryP.sai","loader":"SAI.GetSourceFromPaths","path":"src/QueryP.sai","mtime":"2018-03-11T15:45:20.928Z","fetched":"2018-03-12T01:03:09.782Z"};
...
prototype['SortPiper'] = function(p) {
  var $_d, $_c, $_b, $12, _vars, _outs, _fn, _tester, _bfetch, _afetch, _source, $11, _work, $10, $9, $8, _grammar, _ascending, _Repl, _tools, _pattern, $7, $ = this['SortPiper'] ? this : $bindfail('SortPiper');
  $AI.expectsThrow(p, {
    "clauses": true,
    "tools": true
  }, '\'SortPiper\''); {
    ...
    switch ($12 = (_work.type)) {
      case 'by.expr':
        ...
        _fn = 'function(a,b){' + '\n' + '  var aa,bb;' + '\n' + '  ' + _tester + ';' + '\n' + '  return 0;' + '\n' + '}' + '\n' + '';
        _fn = (((_source === '^\{this}')) ? ('function(a,b){return ' + _ascending + '*$AI.compare_op(a,b)}') : (_fn));
      ...
      case 'by.use':
        ...
        break;
      case 'by.none':
        _pattern = '$AI.sort_op(' + $.SPLIT + ',function(a,b){return ' + _ascending + '*$AI.compare_op(a,b);})' + '\n' + '';
        break;
      default:
        return ({
