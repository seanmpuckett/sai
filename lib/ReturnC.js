...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-07T14:21:44.851Z","fetched":"2018-03-07T17:04:41.947Z"};
...
var __context={"name":"ReturnC.sai","loader":"SAI.GetSourceFromPaths","path":"src/ReturnC.sai","mtime":"2018-03-06T14:30:01.050Z","fetched":"2018-03-07T17:04:41.918Z"};
  ...
  var $_d, $_c, $6, $5, $4, $3, $2, _body, $1, $0, $ = this['ReturnConstruct'] ? this : $bindfail('ReturnConstruct'); {
    ...
    for ($4 in $5) {
      ...
      switch ($2 = ($3.type)) {
        ...
        default:
          return ({
            error: 'SAI compiler: unhandled ' + $3.type + ' -- this is a compiler bug.'
          });
          break;
      };
    }
