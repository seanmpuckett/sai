...
var __context={"loader":"SAI.GetSourceFromFilename","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-20T19:27:10.146Z"};
...
var __context={"loader":"SAI.GetSourceFromFilename","path":"src/PromisingC.sai","mtime":"2018-03-19T22:04:35.035Z","fetched":"2018-03-20T19:27:10.020Z"};
...
prototype['PromisingConstruct'] = function(p) {
  var $_d, $_c, $_b, $16, $15, $14, $13, $12, _block, _body, _tools, $11, $10, _options, _tasker, $9, $8, $7, $6, $5, $4, $3, _finisherText, _finishers, _terminal, $2, _finalText, _finals, $1, _work = p,
    ...
    if (!(_finals[$2])) {
      _finalText = $AI.keys_op(_finals).join('/').toUpperCase();
      /*@:39*/
      return ({
        error: 'SAI compiler: final clause in PROMISING must be ' + _finalText + ', not ' + $2.toUpperCase() + '.'
      });
      /*@:40*/
    }; /*@:41*/
    _terminal = false;
    ...
    for ($6 = 0; $6 < $8; $6++) {
      $5 = $7[$6];
      if ($3 = (_finishers[$5.clause])) {
        _terminal = true;
      } else if ($4 = (_terminal)) {
        _finisherText = $AI.keys_op(_finishers).join('/').toUpperCase();
        /*@:48*/
        return ({
          error: 'SAI compiler: ' + _finisherText + ' should not have any other clauses, such as ' + $5.clause.toUpperCase() + ', following.'
        });
        /*@:49*/
      };
    }
    ...
    for ($14 in $15) {
      ...
      switch ($12 = ($13.type)) {
        case 'promising.verb':
          _body += '$promising$then(' + $13.args.verb + ',\'promising\')';
          /*@:76*/
          break;
        ...
        case 'promising.none':
          ...
          break;
        case 'then.verb':
          _body += '.then(function(p){return $promising$then(' + $13.args.verb + ',\'then\');})';
          /*@:86*/
          break;
        case 'then.outblock':
          _block = _tasker({
          ...
          break;
        case 'catch.verb':
          _body += '.catch(function(p){return $promising$then(' + $13.args.verb + ',\'catch\');})';
          /*@:93*/
          break;
        case 'catch.outblock':
          _block = _tasker({
          ...
          break;
        case 'finally.verb':
          _body += '.finally(function(p){return $promising$then(' + $13.args.verb + ',\'finally\');})';
          /*@:100*/
          break;
        case 'finally.outblock':
          ...
          break;
        case 'resolved.exprs':
          _body += '.then(function(p){return $_resolve(' + $13.args.exprs[1] + ');})';
          /*@:107*/
          break;
        case 'resolved.none':
          ...
          break;
        case 'rejected.exprs':
          _body += '.catch(function(p){return $_reject(' + $13.args.exprs[1] + ');})';
          /*@:113*/
          break;
        case 'rejected.none':
        ...
        case 'finalized.none':
          ...
          break;
        case 'adopt.exprs':
          _body += '.then(function(p){return $promising$then(' + $13.args.exprs[1] + ',\'adopt\')})' + '\n' + '';
          break;
        case 'all.exprs':
          _body += '.then(function(p){return Promise.all(' + $13.args.exprs[1] + ');})';
          /*@:127*/
          break;
        case 'any.exprs':
          _body += '.then(function(p){return Promise.any(' + $13.args.exprs[1] + ');})';
          /*@:130*/
          break;
        default:
          return ({
            error: 'SAI compiler: PROMISING construct unhandled type ' + $13.type
          });
          /*@:133*/
          break;
      };
...
prototype['Documents'] = function(p) {
  var $17, $ = this['Documents'] ? this : $bindfail('Documents'); {
    return ({
      'constructs': {
        'promising': {
