...
var __context={"name":"Construct","loader":"SAI.GetSourceFromPaths","path":"src/Construct.sai","mtime":"2018-03-11T11:59:09.967Z","fetched":"2018-03-18T20:07:21.276Z"};
...
var __context={"name":"PromisingC.sai","loader":"SAI.GetSourceFromPaths","path":"src/PromisingC.sai","mtime":"2018-03-18T20:06:47.515Z","fetched":"2018-03-18T20:07:21.155Z"};
...
prototype['PromisingConstruct'] = function(p) {
  var $_d, $_c, $_b, $9, $8, $7, $6, $5, _block, _body, _tools, $4, $3, _options, _tasker, $2, $1, _work = p,
    ...
    if (!((($2 === 'finally') || (($2 === 'catch') || (($2 === 'rejected') || ($2 === 'finalized')))))) {
      return ({
        error: 'SAI compiler: final clause in PROMISING must be CATCH, FINALLY, REJECTED or FINALIZED, not ' + $2.toUpperCase()
      });
      /*@:38*/
    }; /*@:39*/
    _tasker = function(p) {
    ...
    for ($7 in $8) {
      ...
      switch ($5 = ($6.type)) {
        case 'promising.verb':
          _body += '$promising$then(' + $6.args.verb + ',\'promising\')';
          /*@:67*/
          break;
        ...
        case 'promising.none':
          ...
          break;
        case 'then.verb':
          _body += '.then(function(p){return $promising$then(' + $6.args.verb + ',\'then\');})';
          /*@:77*/
          break;
        case 'then.outblock':
          _block = _tasker({
          ...
          break;
        case 'catch.verb':
          _body += '.catch(function(p){return $promising$then(' + $6.args.verb + ',\'catch\');})';
          /*@:84*/
          break;
        case 'catch.outblock':
          _block = _tasker({
          ...
          break;
        case 'finally.verb':
          _body += '.finally(function(p){return $promising$then(' + $6.args.verb + ',\'finally\');})';
          /*@:91*/
          break;
        ...
        case 'finalized.none':
          ...
          break;
        case 'adopt.exprs':
          _body += '.then(function(){return $promising$then(' + $6.args.exprs[1] + ',\'adopt\')})' + '\n' + '';
          break;
        case 'all.exprs':
