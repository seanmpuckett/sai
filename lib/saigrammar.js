  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$consts = [
          ...
          function(i, ca) {return options.constructs[i].clauses[i].exprblock},
          function(i, ca) {return ca},
          function(i, ca) {return options.constructs[i].clauses[i].block},
          function(i, ca) {return options.constructs[i].clauses[i].exprs},
          function(i, ca) {return options.constructs[i].clauses[i].verb},
          function(i, ca) {return options.constructs[i].clauses[i].none},
          function(i, a, cli) {
                if (cli===i && !options.constructs[i].repeats) return false;
                return options.constructs[i].clauses[cli];
              },
          function(i, a, cli, claa) {return options.constructs[i].clauses[cli].exprblock},
          function(i, a, cli, claa) {return claa},
          function(i, a, cli, claa) {return options.constructs[i].clauses[cli].block},
          function(i, a, cli, claa) {return options.constructs[i].clauses[cli].exprs},
          function(i, a, cli, claa) {return options.constructs[i].clauses[cli].verb},
          function(i, a, cli, claa) {return options.constructs[i].clauses[cli].none},
        ...
        peg$bytecode = [
          ...
          peg$decode(";F._ &;M.Y &;Z.S &;].M &;K.G &;=.A &;B.; &;A.5 &;L./ &;<.) &;6.# &;Y"),
          peg$decode("%;\xCB/\u0381#9:> ! -\"\"&!&#/\u036D$;\xEF/\u0364$%;7/>#9:? \"$ -\"\"&!&#/)$8\":@\"\"%!)(\"'#&'#.\xC9 &%;8/>#9:A \"$ -\"\"&!&#/)$8\":@\"\"%!)(\"'#&'#.\x9E &%;9/>#9:B \"$ -\"\"&!&#/)$8\":@\"\"%!)(\"'#&'#.s &%;:/>#9:C \"$ -\"\"&!&#/)$8\":@\"\"%!)(\"'#&'#.H &%;;/>#9:D \"$ -\"\"&!&#/)$8\":@\"\"%!)(\"'#&'#/\u028A$$%;\xF2/\u0141#;\xCB/\u0138$9:E #'$ -\"\"&!&#/\u0122$;\xEF/\u0119$%;7/B#9:F $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.\xD9 &%;8/B#9:H $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.\xAA &%;9/B#9:I $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.{ &%;:/B#9:J $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.L &%;;/B#9:K $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#/+$8%:L%$*'# )(%'#($'#(#'#(\"'#&'#0\u014B*%;\xF2/\u0141#;\xCB/\u0138$9:E #'$ -\"\"&!&#/\u0122$;\xEF/\u0119$%;7/B#9:F $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.\xD9 &%;8/B#9:H $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.\xAA &%;9/B#9:I $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.{ &%;:/B#9:J $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#.L &%;;/B#9:K $+($ -\"\"&!&#/+$8\":G\"$,)%!)(\"'#&'#/+$8%:L%$*'# )(%'#($'#(#'#(\"'#&'#&/*$8%:M%#$! )(%'#($'#(#'#(\"'#&'#"),
