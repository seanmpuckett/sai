...
...Though it's only actually useful if you really have nothing else to do besides look something up or calculate it. **Exists** gives you a lot more flexibility.
