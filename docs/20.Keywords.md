...
**Orphan** causes the @ scoping prefix within the function to refer to the context of the function call instead of the context of the function definition. 
...
Overlay also works with iterators and treats them like arrays.  If the left side collection is **undefined**, it will be initialized **blank**.
...
This is useful when dealing with small tuples or parsed data:
    ...
    GetPixel task given x,y
      return from buffer.slice (x+y*width)*4, 4
